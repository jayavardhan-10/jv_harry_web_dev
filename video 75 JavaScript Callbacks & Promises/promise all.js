...
//PROMISE ALL WORKS ONLY WHEN ALL THE GIVEN PROMISES ARE DONE PERFECTLY

let p3 = Promise.all([prom1,prom2])
//only if this 2 prom1 and prom2 are done
//then only the below p3.then happens or else wont
